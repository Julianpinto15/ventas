    ...
    <table class="table table-striped table-bordered table-hover">
        <thead class="table-dark">
            <tr class="text-center">
                <th class="text-th">Numero</th>
                <th class="text-th">Nombre</th>
                <th class="text-th">Efectivo</th>
    ...
    foreach($datos as $rows){
        $tabla.='
            <tr class="tr-main text-center">
                <td class="text-td">'.$rows['caja_numero'].'</td>
                <td class="text-td">'.$rows['caja_nombre'].'</td>
                <td class="text-td">'.$rows['caja_efectivo'].'</td>
                <td class="text-td">
                    <button class="text-td btn btn-success btn-sm rounded-pill" onclick="abrirModalEditarCaja({
                        caja_id: \''.$rows['caja_id'].'\',
                        caja_numero: \''.$rows['caja_numero'].'\',
                        caja_nombre: \''.addslashes($rows['caja_nombre']).'\',
                        caja_efectivo: \''.$rows['caja_efectivo'].'\'
                    ...
                    <button onclick="eliminarCaja('.$rows['caja_id'].')" class="text-td btn btn-danger btn-sm rounded-pill">
...
$tabla.='</tbody></table></div>';
			...
			if($total>0 && $pagina<=$numeroPaginas){
				$tabla.='<p class="text-end">Mostrando cajas <strong>'.$pag_inicio.'</strong> al <strong>'.$pag_final.'</strong> de un <strong>total de '.$total.'</strong></p>';
