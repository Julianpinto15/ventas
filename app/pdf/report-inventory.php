...
if ($orden != "" && (in_array($orden, ["nasc", "ndesc", "sasc", "sdesc", "pasc", "pdesc"]))) {
    ...
    // Selección de datos de la empresa
    ...
    // Selección de datos de productos
    $campos_productos = "producto_codigo, producto_nombre, producto_stock_total, producto_precio_venta, producto_tipo_unidad";
    $check_producto = $ins_producto->seleccionarDatos(
        "Normal",
        "producto WHERE producto_estado = 'Habilitado' ORDER BY $orden", // Elimina la condición de stock
        $campos_productos,
        0
    );
        ...
        <div class="main-container">
            <section class="hero-body">
                <div class="hero-body">
                    ...
                    <p class="subtitle has-text-white">No ha seleccionado un orden válido</p>
                </div>
            </section>
        </div>
